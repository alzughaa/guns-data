---
title: "Gun Deaths In the US: A Comparison Study between 2012 and 2019"
...
#### *Description* 
This report analyzes data from 2012 and 2019 on the number of gun deaths in the United States. It provides descriptive statistics and graphs to understand proportions and frequencies of gun deaths related to gender and racial groups in both years. First, I will report results from 2012. I will then report results from 2019. The report then compares results with gun deaths calculated in 2019. I will also examine the relationship between racial groups and gunshot deaths.
...
# Reading in the data from the full data csv. Then I need to exclude years 2013 and 2014.
...
# I will need to change categorical variables to factors to analyze the data. We are asked to examine proportions of type of gun deaths (intent), proportions of race (race) and proportions of gender (sex).I will then start the analysis.
...
In this sample (2021), intent of gunshots/killing is divided into four categories: Accidental, Homicide, Suicide, and Undetermined. Figure 1. illustrates the total of deaths by type. Racial groups are divided into five groups: Asian, Native American, Black, Hispanic, and White. Figure 2. illustrates the number of deaths by gender. Then gender proportions are reported in Figure 3.
...
barplot(intent_props_12, main = "Figure 1. Percentage of Gun Death Types in 2012",
        xlab = "Type of Death",
        ylab = "Percent",
...
```
From Figure 1., 20666 gun deaths comprises 62% of this sample committed suicide by shooting themselves while 12039 which is about 36% of gunshots in the sample were homicide. Accidental and undetermined gunshot cases are very low compared to Suicide and Homicide cases. These percentages are reported in Table 1.
...
barplot(gender_prop_round_12, main = "Figure 2. Percentage of Gender Types in 2012",
        xlab = "Gender",
        ylab = "Percent",
        col = c("red", "blue"),
        ylim = c(0,1))
...
```
We also want to look at the number and proportions of racial groups in this data. In the sample, the largest racial group is White, consisting of 21793 deaths which is about 65% in our sample, followed by Black by 7946 and 23% in the sample. Native American/Alaskan and Asian/Pacific Islander comprise about 1% of deaths and Hispanic are less than 1%.   
...
barplot(race_prop_round_12, main = "Figure 3. Percentage of Racial Groups in 2012",
        xlab = "Race",
        ylab = "Percent",
        col = c("yellow", "red", "blue", "grey"),
        ylim = c(0,1))
...
```
There also seems to be a relationship between racial groups and types of deaths in the sample. Both Homicide and Suicide types of gunshot are the highest reported crimes in this data. 84% of Blacks have committed homicide while only 14% have committed suicide. However, Whites show higher percentage in suicide; about 82%, while about 14% committed suicide. For the Hispanic groups, 64% died in homicide while 33% committed suicide. Even though Asian/Pacific Islanders and Native American/Alaskan groups are smaller in this sample, about 60% of Native American/Native Alaskan and 53% of Asian/Pacific Islanders have commited suicide and about 45% of Asian/Pacific Islanders and 34% of Native American/Alaskans have died in homicide crimes. This relationship is illustrated in Figure 4.  
...
barplot(intent_race_prop_12, main = "Figure 4. Gunshot Deaths by Race in 2012",
        xlab = "Race",
        ylab = "Percentage",
        ylim = c(0,100),
        cex.names = .5,
...
print(intent_counts_19)
print(intent_props_19)


```
*Figure 5. The percentages of gunshot death types in 2019*

```{r echo=FALSE}

# This plot shows the proportions of gunshot deaths by type in 2019. 


barplot(intent_props_19, main = "Figure 5. Percentage of Gun Death Types in 2019",
        xlab = "Type of Death",
        ylab = "Percent",
        col = c("yellow", "red", "blue", "grey"),
        ylim = c(0,0.75))
...
```
In the 2019 sample, about 86% are males (34041 cases) while only 14% (about 5666) cases are females. Figure 6. illustrates this relationship.
```{r}
...
barplot(gender_prop_round_19, main = "Figure 6. Percentage of Gender Types in 2019",
        xlab = "Gender",
        ylab = "Percent",
        col = c("pink", "blue"),
        ylim = c(0,1))
...
We also want to look at the number and proportions of racial groups in 2019. The largest racial group is White consisting of 24212 deaths which is about 61% in our sample, followed by Black 10410 and 26% in the sample. Deaths of Hispanic group comoprise 4058 (about 10%) and Asian/Pacific Islander and Native American/Native Alaskan each are less than 3%. Figure 7. illustrates this relationship.   
...
barplot(race_prop_round_19, main = "Figure 7. Percentage of Racial Groups in 2019",
        xlab = "Race",
        ylab = "Percent",
        col = c("yellow", "red", "blue", "grey"),
        ylim = c(0,1))
...
print(intent_race_prop_19)

barplot(intent_race_prop_19, main = "Figure 8. Gunshot Deaths by Race in 2019",
        beside = FALSE,
        xlab = "Racial Groups",
        ylab = "Percentage",
        ylim = c(0,100),
...
```
Table 4. illustrates the difference between Male and female deaths in 2012 and 2019. 2019 are higher by 5203 cases while female deaths are higher by 941 cases. However, the percentage of males and females in both 2012 and 2019 are about similar (85% male, 14% female). 

*Table 4. Numbers and percentages of deaths by gender in 2012 and 2019.*
...
```
We can look at the difference between racial groups in 2012 and 2019 as well. The pattern of the distribution is about similar in 2012 and 2019. Figure 9. and Table 5? show the difference in proportions in 2012 and 2019. The White group were bigger in proportion by about 3%, although there was an increase by about 3000 cases in the White group in 2019. In contrast, the Black group were lower in proportion in 2012 by about 3%, while for the Hispanic group, their proportion increased by 1% in 2019. The Asian Islanders and the Native Americans, on the other hand, increased in proportion by less than 1% in 2019.           
*Table 5. The relationship between race and number of deaths in 2012 and 2019.*
```{r echo=FALSE}
...
barplot(race_year_props, main= "Figure 9. Proportions of Deaths by Race in 2012 and 2019",
        ylim = c(0,80), xlab = "Year", ylab = "Percent",
        col = c("green", "red", "blue", "yellow", "grey"),
          beside = TRUE,legend= c("Asian", "Black", "Hispanic", "Native American", "White"),
